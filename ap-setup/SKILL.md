---
name: "ap-setup"
description: Sets up BMad Autopilot module in a project. Use when the user requests to 'install ap module', 'configure BMad Autopilot', or 'setup BMad Autopilot'.
---
...
3. Check for per-module configuration at `{project-root}/_bmad/ap/config.yaml` and `{project-root}/_bmad/core/config.yaml`. If either file exists:
